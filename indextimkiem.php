            ...
            while($row=$stm->fetch()){?>
                  <div class="col-sm-3 mt-4">
                    <div class="card " style="width: 16.5rem; ">
                        <img src="image/anhpk&sp/<?php echo $row["hinhanh"]?>" class="card-img-top " alt="... ">
                        <div class="card-body ">
                        ...
                        <a href="chitietSP.php?maSP=<?php echo $row['maSP'] ?>">  <button type="button" class="btn btn btn-outline-secondary">Chi Tiết SP</button></a>
                        </div>
                    </div>
                </div>
            <?php
